/** Functions exercise from slide 89
 */
...
class PirateShip(val numGangPlanks: Int, val firepower: Int)
    ...
    def canOutgun(boat: PirateShip): Boolean = {
        this.firepower > boat.firepower
    }
}
